...
public class LatinHypercubeBoxMullerNormalVariateTest extends AbstractNormalVariateTest {
    ...
    protected NormalVariate createNormalVariate() {
        ...
        return new BoxMullerNormalVariate(multivariate.get(0), multivariate.get(1));
    }
}
