...
public class LinearInterpolationFunctionTest {
    ...
    public void testInterpolation_3_vertices() {
        ...
        final InterpolationFunction f = new InterpolationFunction.Linear(3, x, y);
        ...
        Assert.assertEquals(5.0, f.getY(1.5), 0.0);
        Assert.assertEquals(6.0, f.getY(2.0), 0.0);
        Assert.assertEquals(6.5, f.getY(2.5), 0.0);
