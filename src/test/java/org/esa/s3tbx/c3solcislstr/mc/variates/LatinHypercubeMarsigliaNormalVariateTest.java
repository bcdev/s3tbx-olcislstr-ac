...
public class LatinHypercubeMarsigliaNormalVariateTest extends AbstractNormalVariateTest {

    @Override
    protected NormalVariate createNormalVariate() {
        final Multivariate multivariate = new LatinHypercube(2, AbstractNormalVariateTest.N, 0);
        return new MarsagliaNormalVariate(multivariate.get(0), multivariate.get(1));
    }
}
