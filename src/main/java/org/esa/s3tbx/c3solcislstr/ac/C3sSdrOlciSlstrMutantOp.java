...
public class C3sSdrOlciSlstrMutantOp extends PixelOperator {
        ...
        for (int i = 0; i < sensor.getNumBands(); ++i) {
            ...
            if (toaRefl == geophysicalNoDataValues[i]) {
                ...
                if (mutateSdr) {
                    ...
                    sdr = MutantProvider.getMutatedValue(sdr, sdrUncertainty, zSdr[i], positiveDefinite);
                }
...
//                    final double err_all = Math.sqrt(err_aod * err_aod);
    ...
    public static class Spi extends OperatorSpi {
        ...
        public Spi() {
            super(C3sSdrOlciSlstrMutantOp.class);
        }
    }
